    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/blog')) {
            ...
            if (preg_match('#^/blog(?:/(?P<page>\\d*))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'mmmblog_accueil')), array (  '_controller' => 'MMM\\BlogBundle\\Controller\\BlogController::indexAction',  'page' => 1,));
            }
            ...
            // mmmblog_modifier
            if ($pathinfo === '/blog/modifier') {
                return array (  '_controller' => 'MMM\\BlogBundle\\Controller\\BlogController::modifierAction',  '_route' => 'mmmblog_modifier',);
            }

            // mmmblog_supprimer
            if ($pathinfo === '/blog/supprimer') {
                return array (  '_controller' => 'MMM\\BlogBundle\\Controller\\BlogController::supprimerAction',  '_route' => 'mmmblog_supprimer',);
            }
